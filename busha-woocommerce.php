<?php
/*
Plugin Name:  Busha Pay for Woocommerce
Plugin URI:   #
Description:  This plugin lets you accept payment in Bitcoin and other digital currencies using Busha Pay Payment gateway.
Version:      1.1.0
Author:       Busha Pay
Author URI:   #
*/
